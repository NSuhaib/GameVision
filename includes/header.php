        ...
        <div class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
			...
			<!-- add news -->
			 ...
			 <li>
			<?php
                if(basename($_SERVER['PHP_SELF']) == 'newsletter.php')
                {
            	echo '<a class="activ" href="newsletter.php">Newsletter</a>';
				}
				else
				{
			...
			<!-- test tab -->
			  <li>
			<?php
                if(basename($_SERVER['PHP_SELF']) == 'insertg.php')
                {
            	echo '<a class="activ" href="insertg.php">Add Game</a>';
				}
				else
				{
            	echo '<a href="insertg.php">Add Game</a>';
				}
			?>
            </li>
