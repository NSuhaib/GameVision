...
if (isset($_POST['submitted'])) {
    ...
    if (empty($_POST['game_title'])) {
            ...
            $gt = mysqli_real_escape_string($conn, trim($_POST['game_title']));
    }
    ...
    if (empty($_POST['game_genre'])) {
            ...
            $gg = mysqli_real_escape_string($conn, trim($_POST['game_genre']));
    }
    ...
    if (empty($_POST['game_platform'])) {
            ...
            $gp = mysqli_real_escape_string($conn, trim($_POST['game_platform']));
    }
    ...
    if (empty($_POST['game_tutorial'])) {
            ...
            $gtu = mysqli_real_escape_string($conn, trim($_POST['game_tutorial']));
    }
    ...
    if (empty($_POST['game_description'])) {
            ...
            $gd = mysqli_real_escape_string($conn, trim($_POST['game_description']));
    }
    ...
    if (empty($_POST['image_file_name'])) {
            ...
            $ifn = mysqli_real_escape_string($conn, trim($_POST['image_file_name']));
    }
...
<form class="form-signin" role="form" action="insertg.php" method="post">
